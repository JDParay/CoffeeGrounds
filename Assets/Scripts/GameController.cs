    ...
    void PlayerChose(RPSChoice playerChoice)
{
    ...
    else
    {
        ...
        if (chosen.draw != null)
        {
            StartCoroutine(ShowDrawTemporarily(chosen.draw, 2f));
        }
        ...
        // Coffee meter unchanged on draw
        Debug.Log("Draw!");
    }
}
    ...
    IEnumerator ShowDrawTemporarily(SpriteRenderer drawSprite, float duration)
    {
        ...
        // Hide all draw/happy/mad sprites before showing neutral
        HideAll();
